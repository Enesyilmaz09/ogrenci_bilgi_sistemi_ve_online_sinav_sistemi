...
<body onload="showTime()">
  ...
  <section>
    <h2>Hoş Geldiniz!</h2>
    <div id="clock"></div>
    <p>  <div class="content"> Öğrenci Bilgi Sistemi'ne hoş geldin. Bu sistem aracılığıyla derslerinizi görüntüleyebilir, notlarınızı Değiştirebilirsiniz ve hesap ayarlarınızı yönetebilirsiniz.</div></p>
  </section>
