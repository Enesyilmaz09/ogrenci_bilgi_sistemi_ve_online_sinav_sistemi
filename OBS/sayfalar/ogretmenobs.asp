...
<body>
    ...
    <div class="banner">
        <div class="logo">
          <img src="../img/logo.png" alt="Okul Logosu">
        </div>
        <div class="ogrenci-bilgileri">
                ...
                <div class="sub-menu-wrap" id="subMenu">
                    <div class="sub-menu">
                        <div class="uer-info">
                            ...
                            <h2><%=session("aad")%>&nbsp;<%=session("asoyad")%></h2>
                        </div>
                        <hr>
            ...
            <span class="ogrenci-no"><%=session("aad")%>&nbsp;<%=session("asoyad")%></span>
        </div>
      </div>
    </div>
    ...
    <div class="main"> 
        <div class="navbar"> 
            ...
            <div class="bilgi">
                <ul>
                    <li><%=session("aad")%>&nbsp;<%=session("asoyad")%></li>
                </ul>
            </div>
            <div class="menu">
            <ul > 
                <li> <a href="akademik_anasayfa.asp"  target="ifrm"><i class="fa-solid fa-house"></i> ANASAYFA</a></li>
                ...
                <ul>
                        ...
                        <li><a href="sinifim.asp" target="ifrm">Sınıfım</a></li>
                        
                    </ul>
                </li>   
                <li> <a href="#"> <i class="fa-solid fa-pen"></i> DERS VE DÖNEM İŞLEMLERİ <i class="fa-solid fa-arrow-down-short-wide"></i></a>
                   <ul>
                        <li><a href="derskayit.asp" target="ifrm"> Ders kayıt</a> </li>
                        
                        <li><a href="not_giris.asp" target="ifrm">Not Listesi</a></li>
                    </ul>
                </li>
                <li><a href="#"> <i class="fa-solid fa-id-card"></i> KULLANICI İŞLEMLERİ <i class="fa-solid fa-arrow-down-short-wide"></i></a>
                    <ul>
                      <li><a href="sifre_degis_akademik.asp" target="ifrm">şifre degistirme</a></li>
                    </ul>
                </li>
           </ul> 
        </div>
        ...
        <div class="content">
            <iframe src="akademik_anasayfa.asp" name="ifrm" frameborder="0" width="1618px" height="871px" style="border:1px solid black;"></iframe>
        </div>
    </div>
</body>
</html>